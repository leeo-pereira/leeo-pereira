...
Sou estudante de **Análise e Desenvolvimento de Sistemas**, com foco em **Front-end**, estudando e desenvolvendo projetos práticos em **HTML, CSS e JavaScript**.
...
Recriação da homepage de uma plataforma SaaS B2B como projeto de estudo, com foco em:
- hierarquia visual e clareza de proposta de valor  
- responsividade e organização de layout  
- uso de JavaScript para renderização dinâmica de conteúdo  



### Front-end Journey
🔗 https://github.com/leeo-pereira/front-end-journey

Repositório contínuo de estudos práticos em Front-end, com exercícios e pequenos projetos focados em:
...
Essa experiência influencia minha forma de pensar código, sempre buscando:
- clareza
- organização
